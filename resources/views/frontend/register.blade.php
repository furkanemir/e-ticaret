                ...
                <div class="form-box">
                    <div class="form-tab">
                        <ul class="nav nav-pills nav-fill" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link" id="signin-tab-2" data-toggle="tab" href="{{asset('front/')}}/#signin-2" role="tab" aria-controls="signin-2" aria-selected="false">Kayıt Ol</a>
                            </li>
                        </ul>
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="register-2" role="tabpanel" aria-labelledby="register-tab-2">
                                @if($errors->any())
                                    ...
                                    <br>
                                @endif
                                <form action="{{route('registerPostFront')}}" method="post" >
                                    @csrf
                                    ...
                                    <div class="form-footer" style="display: flex;justify-content: space-between;">
                                        ...
                                        <a href="{{route('login')}}" id="login" class="btn btn-outline-primary-2" >
                                            <span>Giriş Yap</span>
                                            <i class="icon-long-arrow-right"></i>
                                        </a>
                                    </div>
